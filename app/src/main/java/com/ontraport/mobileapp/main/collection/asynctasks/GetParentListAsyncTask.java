...
public class GetParentListAsyncTask<A extends AsyncAdapter<CollectionInfo>>
    ...
    public GetParentListAsyncTask(A adapter, String[] list_fields, int object_id) {
        this(adapter, list_fields, 0, object_id, false);
    }

    public GetParentListAsyncTask(A adapter, String[] list_fields, int count, int object_id) {
        this(adapter, list_fields, count, object_id, false);
    }

    public GetParentListAsyncTask(A adapter, String[] list_fields, int count, int object_id, boolean force_network) {
        super(adapter);
    ...
    protected void onPostExecute(ListResponse list) {
        ...
        adapter.updateParentInfo(new CollectionInfo(object_id, list.getData(), list_fields, count).force(force_network));
    }
